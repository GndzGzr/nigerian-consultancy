    ...
    return (
        <div className="container scheme-light p-24 flex justify-center items-center flex-col">
            <div className="flex flex-col justify-center items-center text-center max-w-4xl ">
                ...
                <p className="mt-3 px-20">We offer end-to-end support for your Nigerian visa application. Our team ensures a smooth, hassle-free experience from initial consultation to final approval.</p>
                <ReadMoreButton />
